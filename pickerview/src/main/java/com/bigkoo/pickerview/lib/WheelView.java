...
public class WheelView extends View {
    ...
    int textCenterBgColor = 0xFFFFFFFF;
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            textCenterBgColor = a.getColor(R.styleable.pickerview_pickerview_textCenterBgColor, textCenterBgColor);
    ...
    private void initPaints() {
        ...
        paintCenterBg.setColor(textCenterBgColor);
    ...
    private void remeasure() {//重新测量
        ...
        firstLineY = (measuredHeight - 1.1f * itemHeight) / 2.0F;
        secondLineY = (measuredHeight + 1.1f * itemHeight) / 2.0F;
...
//                canvas.scale(1.0F, (float) Math.sin(radian));
    ...
    public void setTextCenterBgColor(int textCenterBgColor) {
        if (textCenterBgColor != 0) {
            this.textCenterBgColor = textCenterBgColor;
            paintCenterBg.setColor(this.textCenterBgColor);
        }
    }
