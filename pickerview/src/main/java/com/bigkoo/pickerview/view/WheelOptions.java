...
public class WheelOptions<T> {
    ...
    private void setTextCenterBgColor() {
        wv_option1.setTextCenterBgColor(textCenterBgColor);
        wv_option2.setTextCenterBgColor(textCenterBgColor);
        wv_option3.setTextCenterBgColor(textCenterBgColor);
    }
