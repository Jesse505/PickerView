...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener {
    ...
    private int textCenterBgColor; //中间选中文字的背景
    ...
    public OptionsPickerView(Builder builder) {
        ...
        this.textCenterBgColor = builder.textCenterBgColor;
    ...
    public static class Builder {
         ...
         * @return
         */
        public Builder setTextCenterBgColor(int textCenterBgColor) {
    ...
    private void initView(Context context) {
        ...
        wheelOptions.setTextCenterBgColor(textCenterBgColor);
